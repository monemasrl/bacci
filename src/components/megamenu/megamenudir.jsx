            ...
            {mega && (
                ...
                >
                    <div className="mega-box">
                                ...
                                {inEvidenzaLocalizzato && (
                                    <div className="content-mega">
                                        <div>
                                            ...
                                            <p>
                                                {inEvidenzaLocalizzato.sottotitolo &&
                        ...
                        >
                            <div className="titolo-col-mega">{Termini[locale].tipologia}</div>
                            <ul className="mega-list">
                                {listaCategorie &&
                                    listaCategorie.map(
                                        (item, index) =>
