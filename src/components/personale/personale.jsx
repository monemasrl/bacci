                                ...
                                <>
                                    <div className="box-personale">
                                        ...
                                        <div className="dx">
                                            ...
                                            <h2>{item.personale.nome && item.personale.nome} {item.personale.cognome && item.personale.cognome}</h2>
                                            <span className="professione">{item.personale.professione && item.personale.professione}</span>
                                        </div>
                                    </div>
                                </>
                            )
