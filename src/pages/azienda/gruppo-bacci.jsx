      ...
      <Layout pageTitle={dataFilter.title} locale={'it_IT'} translations={dataFilter.translations} pathName={location.pathname}  >
        ...
        <section className="container sezione-1">
          ...
          <div className="box-dx">
            <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo1.immagine.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo1.immagine.altText} />
          </div>
        </section>
        <section className="container planisfero">
          <h2>{dataFilter.gruppoBacci.sezioneGruppo2.titolo}</h2>
          <div className="box-planisfero"> 
          <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo2.immagine.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo2.immagine.altText} />
        ...
        <section id="macchine" className="container sezione-3">
          <div className="box-sx">
            ...
            <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo3.immagine.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo3.immagine.altText} />
        ...
        <section id="meccanica" className="container sezione-3">
          <div className="box-sx">
            ...
            <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo3.immagine2.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo3.immagine2.altText} />
        ...
        <section id="automation" className="container sezione-3">
          <div className="box-sx">
            ...
            <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo3.immagine3.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo3.immagine3.altText} />
        ...
        <section id="america" className="container sezione-3">
          <div className="box-sx">
            ...
            <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo3.immagine4.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo3.immagine4.altText} />
        ...
        <section id="china" className="container sezione-3">
          <div className="box-sx">
            ...
            <GatsbyImage image={dataFilter.gruppoBacci.sezioneGruppo3.immagine5.localFile.childImageSharp.gatsbyImageData} width='400' alt={dataFilter.gruppoBacci.sezioneGruppo3.immagine5.altText} />
